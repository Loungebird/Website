      ...
      <div className={styles.container}>
        ...
        >
          ...
          <h1 className={styles.title}>
            Lounge Smarter at<br />
            <span className={styles.titleAccent}>London Heathrow</span>
          </h1>

          <p className={styles.subtitle}>
            Real-time occupancy insights for Terminal 5 lounges.
            Find the perfect space to relax before your flight.
          </p>
        ...
        >
          <div className={styles.deviceContainer}>
            <div className={styles.ipadFrame}>
              <img
                src="/images/screenshots/ipad/1.png"
                alt="Loungebird on iPad"
                className={styles.ipadScreen}
              />
            </div>
            <div className={styles.iphoneFrame}>
              <img
                src="/images/screenshots/ios/1.png"
                alt="Loungebird on iPhone"
